...
These settings apply only when `--tag=package-19.1` is specified on the command line.

```yaml $(tag) == 'package-19.1'
input-file:
  - Microsoft.ServiceFabric/stable/19.1/servicefabric.json
```
### Tag: 1.0.0
